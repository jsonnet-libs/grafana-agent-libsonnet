{
  ...
  spec: {
    ...
    logs: {
      '#clients':: d.obj(help='"Global set of clients to use when a discovered LogsInstance does not have any clients defined."'),
      clients: {
      ...
      '#withClients':: d.fn(help='"Global set of clients to use when a discovered LogsInstance does not have any clients defined."', args=[d.arg(name='clients', type=d.T.array)]),
      withClients(clients): { spec+: { logs+: { clients: if std.isArray(v=clients) then clients else [clients] } } },
      '#withClientsMixin':: d.fn(help='"Global set of clients to use when a discovered LogsInstance does not have any clients defined."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='clients', type=d.T.array)]),
