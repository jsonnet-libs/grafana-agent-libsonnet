{
  ...
  '#spec':: d.obj(help='"Specifies the desired behavior of the Integration."'),
  spec: {
    '#configMaps':: d.obj(help='"An extra list of keys from ConfigMaps in the same namespace as the Integration which will be mounted into the Grafana Agent pod running this integration. \\n ConfigMaps will be mounted at /etc/grafana-agent/integrations/configMaps/<configmap_namespace>/<configmap_name>/<key>."'),
    configMaps: {
    ...
    '#secrets':: d.obj(help='"An extra list of keys from Secrets in the same namespace as the Integration which will be mounted into the Grafana Agent pod running this integration. \\n Secrets will be mounted at /etc/grafana-agent/integrations/secrets/<secret_namespace>/<secret_name>/<key>."'),
    secrets: {
    ...
    '#type':: d.obj(help='"Type informs Grafana Agent Operator how to manage the integration being configured."'),
    type: {
      '#withAllNodes':: d.fn(help='"When true, the configured integration should be run on every Node in the cluster. This is required for integrations that generate Node-specific metrics like node_exporter, otherwise it must be false to avoid generating duplicate metrics."', args=[d.arg(name='allNodes', type=d.T.boolean)]),
      withAllNodes(allNodes): { spec+: { type+: { allNodes: allNodes } } },
      '#withUnique':: d.fn(help='"Whether this integration can only be defined once for a Grafana Agent process, such as statsd_exporter. It is invalid for a GrafanaAgent to discover multiple unique Integrations with the same integration name (i.e., a single GrafanaAgent cannot deploy two statsd_exporters)."', args=[d.arg(name='unique', type=d.T.boolean)]),
      withUnique(unique): { spec+: { type+: { unique: unique } } },
    },
    '#volumeMounts':: d.obj(help='"An extra list of VolumeMounts to be associated with the Grafana Agent pods running this integration. VolumeMount names will be mutated to be unique across all used IntegrationSpecs. \\n Mount paths should include the namespace/name of the Integration CR to avoid potentially colliding with other resources."'),
    volumeMounts: {
    ...
    '#volumes':: d.obj(help="\"An extra list of Volumes to be associated with the Grafana Agent pods running this integration. Volume names will be mutated to be unique across all Integrations. Note that the specified volumes should be able to tolerate existing on multiple pods at once when type is daemonset. \\n Don't use volumes for loading secrets/configMaps from the same namespace as the Integration; use the secrets and configMaps fields instead.\""),
    volumes: {
    ...
    '#withConfig':: d.fn(help='"The configuration for the named integration. Note that integrations are deployed with the integrations-next feature flag, which has different common settings: \\n https://grafana.com/docs/agent/latest/configuration/integrations/integrations-next/"', args=[d.arg(name='config', type=d.T.object)]),
    withConfig(config): { spec+: { config: config } },
    '#withConfigMaps':: d.fn(help='"An extra list of keys from ConfigMaps in the same namespace as the Integration which will be mounted into the Grafana Agent pod running this integration. \\n ConfigMaps will be mounted at /etc/grafana-agent/integrations/configMaps/<configmap_namespace>/<configmap_name>/<key>."', args=[d.arg(name='configMaps', type=d.T.array)]),
    withConfigMaps(configMaps): { spec+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } },
    '#withConfigMapsMixin':: d.fn(help='"An extra list of keys from ConfigMaps in the same namespace as the Integration which will be mounted into the Grafana Agent pod running this integration. \\n ConfigMaps will be mounted at /etc/grafana-agent/integrations/configMaps/<configmap_namespace>/<configmap_name>/<key>."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configMaps', type=d.T.array)]),
    withConfigMapsMixin(configMaps): { spec+: { configMaps+: if std.isArray(v=configMaps) then configMaps else [configMaps] } },
    '#withConfigMixin':: d.fn(help='"The configuration for the named integration. Note that integrations are deployed with the integrations-next feature flag, which has different common settings: \\n https://grafana.com/docs/agent/latest/configuration/integrations/integrations-next/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
    withConfigMixin(config): { spec+: { config+: config } },
    '#withName':: d.fn(help='"Name of the integration to run (e.g., \\"node_exporter\\", \\"mysqld_exporter\\")."', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { spec+: { name: name } },
    '#withSecrets':: d.fn(help='"An extra list of keys from Secrets in the same namespace as the Integration which will be mounted into the Grafana Agent pod running this integration. \\n Secrets will be mounted at /etc/grafana-agent/integrations/secrets/<secret_namespace>/<secret_name>/<key>."', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecrets(secrets): { spec+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withSecretsMixin':: d.fn(help='"An extra list of keys from Secrets in the same namespace as the Integration which will be mounted into the Grafana Agent pod running this integration. \\n Secrets will be mounted at /etc/grafana-agent/integrations/secrets/<secret_namespace>/<secret_name>/<key>."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecretsMixin(secrets): { spec+: { secrets+: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withVolumeMounts':: d.fn(help='"An extra list of VolumeMounts to be associated with the Grafana Agent pods running this integration. VolumeMount names will be mutated to be unique across all used IntegrationSpecs. \\n Mount paths should include the namespace/name of the Integration CR to avoid potentially colliding with other resources."', args=[d.arg(name='volumeMounts', type=d.T.array)]),
    withVolumeMounts(volumeMounts): { spec+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } },
    '#withVolumeMountsMixin':: d.fn(help='"An extra list of VolumeMounts to be associated with the Grafana Agent pods running this integration. VolumeMount names will be mutated to be unique across all used IntegrationSpecs. \\n Mount paths should include the namespace/name of the Integration CR to avoid potentially colliding with other resources."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeMounts', type=d.T.array)]),
    withVolumeMountsMixin(volumeMounts): { spec+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } },
    '#withVolumes':: d.fn(help="\"An extra list of Volumes to be associated with the Grafana Agent pods running this integration. Volume names will be mutated to be unique across all Integrations. Note that the specified volumes should be able to tolerate existing on multiple pods at once when type is daemonset. \\n Don't use volumes for loading secrets/configMaps from the same namespace as the Integration; use the secrets and configMaps fields instead.\"", args=[d.arg(name='volumes', type=d.T.array)]),
    withVolumes(volumes): { spec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } },
    '#withVolumesMixin':: d.fn(help="\"An extra list of Volumes to be associated with the Grafana Agent pods running this integration. Volume names will be mutated to be unique across all Integrations. Note that the specified volumes should be able to tolerate existing on multiple pods at once when type is daemonset. \\n Don't use volumes for loading secrets/configMaps from the same namespace as the Integration; use the secrets and configMaps fields instead.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='volumes', type=d.T.array)]),
