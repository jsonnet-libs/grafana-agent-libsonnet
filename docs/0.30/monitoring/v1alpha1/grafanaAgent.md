...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.integrations`](#obj-specintegrations)
    * [`obj spec.integrations.namespaceSelector`](#obj-specintegrationsnamespaceselector)
      ...
      * [`obj spec.integrations.namespaceSelector.matchExpressions`](#obj-specintegrationsnamespaceselectormatchexpressions)
        ...
        * [`fn withValues(values)`](#fn-specintegrationsnamespaceselectormatchexpressionswithvalues)
      ...
      * [`obj spec.logs.clients.tlsConfig`](#obj-speclogsclientstlsconfig)
        ...
        * [`obj spec.logs.clients.tlsConfig.cert`](#obj-speclogsclientstlsconfigcert)
          * [`obj spec.logs.clients.tlsConfig.cert.configMap`](#obj-speclogsclientstlsconfigcertconfigmap)
            * [`fn withKey(key)`](#fn-speclogsclientstlsconfigcertconfigmapwithkey)
  ...
  * [`obj spec.metrics`](#obj-specmetrics)
    ...
    * [`obj spec.metrics.instanceNamespaceSelector`](#obj-specmetricsinstancenamespaceselector)
      * [`fn withMatchExpressions(matchExpressions)`](#fn-specmetricsinstancenamespaceselectorwithmatchexpressions)
      ...
      * [`obj spec.metrics.remoteWrite.oauth2`](#obj-specmetricsremotewriteoauth2)
        ...
        * [`obj spec.metrics.remoteWrite.oauth2.clientId`](#obj-specmetricsremotewriteoauth2clientid)
          * [`obj spec.metrics.remoteWrite.oauth2.clientId.configMap`](#obj-specmetricsremotewriteoauth2clientidconfigmap)
            ...
            * [`fn withName(name)`](#fn-specmetricsremotewriteoauth2clientidconfigmapwithname)
      ...
      * [`obj spec.metrics.remoteWrite.tlsConfig`](#obj-specmetricsremotewritetlsconfig)
        ...
        * [`obj spec.metrics.remoteWrite.tlsConfig.cert`](#obj-specmetricsremotewritetlsconfigcert)
          ...
          * [`obj spec.metrics.remoteWrite.tlsConfig.cert.secret`](#obj-specmetricsremotewritetlsconfigcertsecret)
            ...
            * [`fn withName(name)`](#fn-specmetricsremotewritetlsconfigcertsecretwithname)
...
### fn spec.withDisableReporting

```ts
withDisableReporting(disableReporting)
```

"disableReporting disable reporting of enabled feature flags to Grafana."

### fn spec.withDisableSupportBundle

```ts
withDisableSupportBundle(disableSupportBundle)
```

"disableSupportBundle disables the generation of support bundles."

### fn spec.withEnableConfigReadAPI

```ts
withEnableConfigReadAPI(enableConfigReadAPI)
```
...
## obj spec.apiServer.authorization

"Authorization section for accessing apiserver"

### fn spec.apiServer.authorization.withCredentialsFile
...
### fn spec.apiServer.authorization.withType
...
## obj spec.apiServer.authorization.credentials

"The secret's key that contains the credentials of the request"

### fn spec.apiServer.authorization.credentials.withKey
...
### fn spec.apiServer.authorization.credentials.withName
...
### fn spec.apiServer.authorization.credentials.withOptional
...
## obj spec.integrations.namespaceSelector
...
### fn spec.integrations.namespaceSelector.withMatchExpressions
...
### fn spec.integrations.namespaceSelector.withMatchExpressionsMixin
...
### fn spec.integrations.namespaceSelector.withMatchLabels
...
### fn spec.integrations.namespaceSelector.withMatchLabelsMixin
...
## obj spec.integrations.namespaceSelector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.integrations.namespaceSelector.matchExpressions.withKey
...
### fn spec.integrations.namespaceSelector.matchExpressions.withOperator
...
### fn spec.integrations.namespaceSelector.matchExpressions.withValues
...
### fn spec.integrations.namespaceSelector.matchExpressions.withValuesMixin
...
### fn spec.integrations.selector.withMatchExpressionsMixin
...
### fn spec.integrations.selector.withMatchLabels
...
### fn spec.integrations.selector.withMatchLabelsMixin
...
## obj spec.integrations.selector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.integrations.selector.matchExpressions.withKey
...
### fn spec.integrations.selector.matchExpressions.withOperator
...
### fn spec.integrations.selector.matchExpressions.withValues
...
### fn spec.integrations.selector.matchExpressions.withValuesMixin
...
## obj spec.metrics.remoteWrite.oauth2

"Oauth2 for URL"

### fn spec.metrics.remoteWrite.oauth2.withEndpointParams
...
### fn spec.metrics.remoteWrite.oauth2.withEndpointParamsMixin
...
### fn spec.metrics.remoteWrite.oauth2.withScopes
...
### fn spec.metrics.remoteWrite.oauth2.withScopesMixin
...
### fn spec.metrics.remoteWrite.oauth2.withTokenUrl
...
## obj spec.metrics.remoteWrite.oauth2.clientId

"The secret or configmap containing the OAuth2 client id"

## obj spec.metrics.remoteWrite.oauth2.clientId.configMap

"ConfigMap containing data to use for the targets."

### fn spec.metrics.remoteWrite.oauth2.clientId.configMap.withKey
...
### fn spec.metrics.remoteWrite.oauth2.clientId.configMap.withName
...
### fn spec.metrics.remoteWrite.oauth2.clientId.configMap.withOptional
...
## obj spec.metrics.remoteWrite.oauth2.clientId.secret

"Secret containing data to use for the targets."

### fn spec.metrics.remoteWrite.oauth2.clientId.secret.withKey
...
### fn spec.metrics.remoteWrite.oauth2.clientId.secret.withName
...
### fn spec.metrics.remoteWrite.oauth2.clientId.secret.withOptional
...
## obj spec.metrics.remoteWrite.oauth2.clientSecret

"The secret containing the OAuth2 client secret"

### fn spec.metrics.remoteWrite.oauth2.clientSecret.withKey
...
### fn spec.metrics.remoteWrite.oauth2.clientSecret.withName
...
### fn spec.metrics.remoteWrite.oauth2.clientSecret.withOptional
