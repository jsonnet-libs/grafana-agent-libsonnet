{
  ...
  spec: {
    ...
    apiServer: {
      ...
      authorization: {
        ...
        credentials: {
          ...
          withKey(key): { spec+: { apiServer+: { authorization+: { credentials+: { key: key } } } } },
          ...
          withName(name): { spec+: { apiServer+: { authorization+: { credentials+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { apiServer+: { authorization+: { credentials+: { optional: optional } } } } },
        },
        ...
        withCredentialsFile(credentialsFile): { spec+: { apiServer+: { authorization+: { credentialsFile: credentialsFile } } } },
        ...
        withType(type): { spec+: { apiServer+: { authorization+: { type: type } } } },
      },
    ...
    '#integrations':: d.obj(help='"Integrations controls the integration subsystem of the Agent and settings unique to integration-specific pods that are deployed."'),
    integrations: {
      '#namespaceSelector':: d.obj(help='"Label selector for namespaces to search when discovering integration resources. If nil, integration resources are only discovered in the namespace of the GrafanaAgent resource. \\n Set to `{}` to search all namespaces."'),
      namespaceSelector: {
        '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
        matchExpressions: {
          '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { integrations+: { namespaceSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { integrations+: { namespaceSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { integrations+: { namespaceSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { integrations+: { namespaceSelector+: { matchLabels+: matchLabels } } } },
      },
      '#selector':: d.obj(help='"Label selector to find Integration resources to run. When nil, no integration resources will be defined."'),
      selector: {
        '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
        matchExpressions: {
          '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { integrations+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { integrations+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { integrations+: { selector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { integrations+: { selector+: { matchLabels+: matchLabels } } } },
      },
    },
    '#logs':: d.obj(help='"Logs controls the logging subsystem of the Agent and settings unique to logging-specific pods that are deployed."'),
    logs: {
      '#clients':: d.obj(help='"A global set of clients to use when a discovered LogsInstance does not have any clients defined."'),
      clients: {
      ...
      '#instanceNamespaceSelector':: d.obj(help='"InstanceNamespaceSelector are the set of labels to determine which namespaces to watch for LogInstances. If not provided, only checks own namespace."'),
      instanceNamespaceSelector: {
        ...
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { logs+: { instanceNamespaceSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { logs+: { instanceNamespaceSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { logs+: { instanceNamespaceSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { logs+: { instanceNamespaceSelector+: { matchLabels+: matchLabels } } } },
      },
      '#instanceSelector':: d.obj(help='"InstanceSelector determines which LogInstances should be selected for running. Each instance runs its own set of Prometheus components, including service discovery, scraping, and remote_write."'),
      instanceSelector: {
        '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
        matchExpressions: {
          '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { logs+: { instanceSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { logs+: { instanceSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { logs+: { instanceSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { logs+: { instanceSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withClients':: d.fn(help='"A global set of clients to use when a discovered LogsInstance does not have any clients defined."', args=[d.arg(name='clients', type=d.T.array)]),
      withClients(clients): { spec+: { logs+: { clients: if std.isArray(v=clients) then clients else [clients] } } },
      '#withClientsMixin':: d.fn(help='"A global set of clients to use when a discovered LogsInstance does not have any clients defined."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='clients', type=d.T.array)]),
      withClientsMixin(clients): { spec+: { logs+: { clients+: if std.isArray(v=clients) then clients else [clients] } } },
      '#withEnforcedNamespaceLabel':: d.fn(help='"EnforcedNamespaceLabel enforces adding a namespace label of origin for each metric that is user-created. The label value will always be the namespace of the object that is being created."', args=[d.arg(name='enforcedNamespaceLabel', type=d.T.string)]),
      withEnforcedNamespaceLabel(enforcedNamespaceLabel): { spec+: { logs+: { enforcedNamespaceLabel: enforcedNamespaceLabel } } },
      '#withIgnoreNamespaceSelectors':: d.fn(help='"IgnoreNamespaceSelectors, if true, will ignore NamespaceSelector settings from the PodLogs configs, and they will only discover endpoints within their current namespace."', args=[d.arg(name='ignoreNamespaceSelectors', type=d.T.boolean)]),
      withIgnoreNamespaceSelectors(ignoreNamespaceSelectors): { spec+: { logs+: { ignoreNamespaceSelectors: ignoreNamespaceSelectors } } },
      '#withLogsExternalLabelName':: d.fn(help='"LogsExternalLabelName is the name of the external label used to denote Grafana Agent cluster. Defaults to \\"cluster.\\" External label will _not_ be added when value is set to the empty string."', args=[d.arg(name='logsExternalLabelName', type=d.T.string)]),
      withLogsExternalLabelName(logsExternalLabelName): { spec+: { logs+: { logsExternalLabelName: logsExternalLabelName } } },
    },
    '#metrics':: d.obj(help='"Metrics controls the metrics subsystem of the Agent and settings unique to metrics-specific pods that are deployed."'),
    metrics: {
      ...
      arbitraryFSAccessThroughSMs: {
        ...
        withDeny(deny): { spec+: { metrics+: { arbitraryFSAccessThroughSMs+: { deny: deny } } } },
      },
      '#instanceNamespaceSelector':: d.obj(help='"InstanceNamespaceSelector are the set of labels to determine which namespaces to watch for MetricsInstances. If not provided, only checks own namespace."'),
      instanceNamespaceSelector: {
        '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
        matchExpressions: {
          '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { metrics+: { instanceNamespaceSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { metrics+: { instanceNamespaceSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { metrics+: { instanceNamespaceSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { metrics+: { instanceNamespaceSelector+: { matchLabels+: matchLabels } } } },
      },
      '#instanceSelector':: d.obj(help='"InstanceSelector determines which MetricsInstances should be selected for running. Each instance runs its own set of Metrics components, including service discovery, scraping, and remote_write."'),
      instanceSelector: {
        '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
        matchExpressions: {
          '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { metrics+: { instanceSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { metrics+: { instanceSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { metrics+: { instanceSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { metrics+: { instanceSelector+: { matchLabels+: matchLabels } } } },
      },
      '#remoteWrite':: d.obj(help='"RemoteWrite controls default remote_write settings for all instances. If an instance does not provide its own remoteWrite settings, these will be used instead."'),
      remoteWrite: {
      ...
      '#withEnforcedNamespaceLabel':: d.fn(help='"EnforcedNamespaceLabel enforces adding a namespace label of origin for each metric that is user-created. The label value will always be the namespace of the object that is being created."', args=[d.arg(name='enforcedNamespaceLabel', type=d.T.string)]),
      withEnforcedNamespaceLabel(enforcedNamespaceLabel): { spec+: { metrics+: { enforcedNamespaceLabel: enforcedNamespaceLabel } } },
      ...
      withEnforcedSampleLimit(enforcedSampleLimit): { spec+: { metrics+: { enforcedSampleLimit: enforcedSampleLimit } } },
      ...
      withEnforcedTargetLimit(enforcedTargetLimit): { spec+: { metrics+: { enforcedTargetLimit: enforcedTargetLimit } } },
      ...
      withExternalLabels(externalLabels): { spec+: { metrics+: { externalLabels: externalLabels } } },
      ...
      withExternalLabelsMixin(externalLabels): { spec+: { metrics+: { externalLabels+: externalLabels } } },
      ...
      withIgnoreNamespaceSelectors(ignoreNamespaceSelectors): { spec+: { metrics+: { ignoreNamespaceSelectors: ignoreNamespaceSelectors } } },
      '#withMetricsExternalLabelName':: d.fn(help='"MetricsExternalLabelName is the name of the external label used to denote Grafana Agent cluster. Defaults to \\"cluster.\\" External label will _not_ be added when value is set to the empty string."', args=[d.arg(name='metricsExternalLabelName', type=d.T.string)]),
      withMetricsExternalLabelName(metricsExternalLabelName): { spec+: { metrics+: { metricsExternalLabelName: metricsExternalLabelName } } },
      ...
      withOverrideHonorLabels(overrideHonorLabels): { spec+: { metrics+: { overrideHonorLabels: overrideHonorLabels } } },
      ...
      withOverrideHonorTimestamps(overrideHonorTimestamps): { spec+: { metrics+: { overrideHonorTimestamps: overrideHonorTimestamps } } },
      ...
      withRemoteWrite(remoteWrite): { spec+: { metrics+: { remoteWrite: if std.isArray(v=remoteWrite) then remoteWrite else [remoteWrite] } } },
      ...
      withRemoteWriteMixin(remoteWrite): { spec+: { metrics+: { remoteWrite+: if std.isArray(v=remoteWrite) then remoteWrite else [remoteWrite] } } },
      '#withReplicaExternalLabelName':: d.fn(help='"ReplicaExternalLabelName is the name of the metrics external label used to denote replica name. Defaults to __replica__. External label will _not_ be added when value is set to the empty string."', args=[d.arg(name='replicaExternalLabelName', type=d.T.string)]),
      withReplicaExternalLabelName(replicaExternalLabelName): { spec+: { metrics+: { replicaExternalLabelName: replicaExternalLabelName } } },
      ...
      withReplicas(replicas): { spec+: { metrics+: { replicas: replicas } } },
      ...
      withScrapeInterval(scrapeInterval): { spec+: { metrics+: { scrapeInterval: scrapeInterval } } },
      ...
      withScrapeTimeout(scrapeTimeout): { spec+: { metrics+: { scrapeTimeout: scrapeTimeout } } },
      ...
      withShards(shards): { spec+: { metrics+: { shards: shards } } },
    },
    ...
    '#tolerations':: d.obj(help="\"Tolerations, if specified, controls the pod's tolerations.\""),
    tolerations: {
    ...
    '#topologySpreadConstraints':: d.obj(help="\"TopologySpreadConstraints, if specified, controls the pod's topology spread constraints.\""),
    ...
    '#volumeMounts':: d.obj(help='"VolumeMounts allows configuration of additional VolumeMounts on the output StatefulSet definition. VolumEMounts specified will be appended to other VolumeMounts in the Grafana Agent container that are generated as a result of StorageSpec objects."'),
    volumeMounts: {
      '#withMountPath':: d.fn(help="\"Path within the container at which the volume should be mounted.  Must not contain ':'.\"", args=[d.arg(name='mountPath', type=d.T.string)]),
      withMountPath(mountPath): { mountPath: mountPath },
      '#withMountPropagation':: d.fn(help='"mountPropagation determines how mounts are propagated from the host to container and the other way around. When not set, MountPropagationNone is used. This field is beta in 1.10."', args=[d.arg(name='mountPropagation', type=d.T.string)]),
    ...
    '#withConfigMaps':: d.fn(help='"ConfigMaps is a liset of config maps in the same namespace as the GrafanaAgent object which will be mounted into each running Grafana Agent pod. The ConfigMaps are mounted into /etc/grafana-agent/extra-configmaps/<configmap-name>."', args=[d.arg(name='configMaps', type=d.T.array)]),
    withConfigMaps(configMaps): { spec+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } },
    '#withConfigMapsMixin':: d.fn(help='"ConfigMaps is a liset of config maps in the same namespace as the GrafanaAgent object which will be mounted into each running Grafana Agent pod. The ConfigMaps are mounted into /etc/grafana-agent/extra-configmaps/<configmap-name>."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configMaps', type=d.T.array)]),
    ...
    '#withDisableReporting':: d.fn(help='"disableReporting disable reporting of enabled feature flags to Grafana."', args=[d.arg(name='disableReporting', type=d.T.boolean)]),
    withDisableReporting(disableReporting): { spec+: { disableReporting: disableReporting } },
    '#withDisableSupportBundle':: d.fn(help='"disableSupportBundle disables the generation of support bundles."', args=[d.arg(name='disableSupportBundle', type=d.T.boolean)]),
    withDisableSupportBundle(disableSupportBundle): { spec+: { disableSupportBundle: disableSupportBundle } },
    '#withEnableConfigReadAPI':: d.fn(help='"enableConfigReadAPI enables the read API for viewing currently running config port 8080 on the agent."', args=[d.arg(name='enableConfigReadAPI', type=d.T.boolean)]),
    withEnableConfigReadAPI(enableConfigReadAPI): { spec+: { enableConfigReadAPI: enableConfigReadAPI } },
    ...
    '#withSecrets':: d.fn(help='"Secrets is a list of secrets in the same namespace as the GrafanaAgent object which will be mounted into each running Grafana Agent pod. The secrets are mounted into /etc/grafana-agent/extra-secrets/<secret-name>."', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecrets(secrets): { spec+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withSecretsMixin':: d.fn(help='"Secrets is a list of secrets in the same namespace as the GrafanaAgent object which will be mounted into each running Grafana Agent pod. The secrets are mounted into /etc/grafana-agent/extra-secrets/<secret-name>."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
